...
if(empty(trim($_POST["Username"]))){
    ...
    if($stmt){
        ...
        // Try to exececute this statement
...
// If there were no errors, go and inset into database
...
<body>
	...
	<div class="main-w3layouts wrapper">
		...
		<div class="main-agileinfo">
          ...
          <input class="text email" type="text" name="id" placeholder="Enter id" required="">
